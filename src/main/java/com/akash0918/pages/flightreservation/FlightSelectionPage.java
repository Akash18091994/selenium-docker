package com.akash0918.pages.flightreservation;

import com.akash0918.pages.AbstractPage;
...
public class FlightSelectionPage extends AbstractPage {
    ...
    public void selectFlights() {
        int random = ThreadLocalRandom.current().nextInt(0,arrivalFlightsOptions.size());
